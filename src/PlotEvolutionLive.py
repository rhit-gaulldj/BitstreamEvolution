...
def show_evolution_figure(saveimage=False, animate=True):
...
def show_violins_figure(saveimage=False, animate=True):
    fig2 = plt.figure()
    ax7 = fig2.add_subplot(1, 1, 1)
    ani7 = plot(fig2, anim_violin_plots)
    fig2.show()

def show_heatmap_figure(saveimage=False, animate=True):
    fig3 = plt.figure()
    ax8 = fig3.add_subplot(1,1,1)
    ani8 = plot(fig3, anim_heatmap)
    fig3.show()

def show_pulses_figure(saveimage=False, animate=True):
    fig4 = plt.figure()
...
def show_map_figure(saveimage=False, animate=True):
    fig_map = plt.figure()
...
def create_generation_axes(animate=True):
    pass

def create_evolution_axes(animate=True):
    pass

def create_pulse_evolution_axes(animate=True):
    pass

def create_waveform_axes(animate=True):
    pass

def create_tone_discriminator_axes(animate=True):
    pass

def create_map_elites_variance_axes(animate=True):
    pass

def create_map_elites_pulse_axes(animate=True):
    pass

def create_multiple_populations_axes(animate=True):
    pass

def create_violins_fitness_axes(animate=True):
    pass

def create_violins_pulse_axes(animate=True):
    pass

def create_heatmap_variance_axes(animate=True):
    pass

def create_heatmap_pulse_axes(animate=True):
    pass

def display_generation_data(i, ax):
    pass

def display_evolution_data(i, ax):
    pass

def display_pulse_evolution_data(i, ax):
    pass

def display_waveform_data(i, ax):
    pass

def display_tone_discriminator_data(i, ax):
    pass

def display_map_elites_variance_data(i, ax):
    pass

def display_map_elites_pulse_axes(i, ax):
    pass

def display_multiple_populations_data(i, ax):
    pass

def display_violins_fitness_data(i, ax):
    pass

def display_violins_pulse_data(i, ax):
    pass

def display_heatmap_variance_data(i, ax):
    pass

def display_heatmap_pulse_data(i, ax):
    pass
...
def anim_heatmap(i):
    ...
    for line in lines:
        if len(line) > 1:
            ...
            pts = vals[1].split(',')
            for pt in pts:
                if 38000 <= float(pt) and float(pt) <= 42000:
    ...
    ax8.clear()                         
    ax8.hist2d(gens,collections)

    if config.is_pulse_func():
        ax8.set(xlabel='Generation', ylabel='Pulses', title='Pulse Count Histogram', ylim=(38000, 42000))
    else:
...
def run():
    ...
    show_evolution_figure(animate=True, saveimage=config.get_save_plots())
    show_violins_figure(animate=True, saveimage=config.get_save_plots())

    if config.get_simulation_mode() == 'FULLY_INTRINSIC':
        show_heatmap_figure(animate=True, saveimage=config.get_save_plots())

    if config.is_pulse_count():
        show_pulses_figure(animate=True, saveimage=config.get_save_plots())

    if config.get_selection_type() == 'MAP_ELITES':
        show_map_figure(animate=True, saveimage=config.get_save_plots())
